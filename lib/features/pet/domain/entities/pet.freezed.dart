...
mixin _$Pet {
 ...
 String get id; String get uid; String get name; Address get address; Gender get gender; int? get age; double? get weight; Species get species; String get breed; String get description; String get imageUrl; DateTime get createdAt; DateTime get updatedAt; bool get isAdopted; bool get isDeleted; DateTime? get deletedAt;
...
@override
String toString() {
  return 'Pet(id: $id, uid: $uid, name: $name, address: $address, gender: $gender, age: $age, weight: $weight, species: $species, breed: $breed, description: $description, imageUrl: $imageUrl, createdAt: $createdAt, updatedAt: $updatedAt, isAdopted: $isAdopted, isDeleted: $isDeleted, deletedAt: $deletedAt)';
}
...
@useResult
$Res call({
 String id, String uid, String name, Address address, Gender gender, int? age, double? weight, Species species, String breed, String description, String imageUrl, DateTime createdAt, DateTime updatedAt, bool isAdopted, bool isDeleted, DateTime? deletedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String uid,  String name,  Address address,  Gender gender,  int? age,  double? weight,  Species species,  String breed,  String description,  String imageUrl,  DateTime createdAt,  DateTime updatedAt,  bool isAdopted,  bool isDeleted,  DateTime? deletedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Pet() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String uid,  String name,  Address address,  Gender gender,  int? age,  double? weight,  Species species,  String breed,  String description,  String imageUrl,  DateTime createdAt,  DateTime updatedAt,  bool isAdopted,  bool isDeleted,  DateTime? deletedAt)  $default,) {final _that = this;
switch (_that) {
case _Pet():
return $default(_that.id,_that.uid,_that.name,_that.address,_that.gender,_that.age,_that.weight,_that.species,_that.breed,_that.description,_that.imageUrl,_that.createdAt,_that.updatedAt,_that.isAdopted,_that.isDeleted,_that.deletedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String uid,  String name,  Address address,  Gender gender,  int? age,  double? weight,  Species species,  String breed,  String description,  String imageUrl,  DateTime createdAt,  DateTime updatedAt,  bool isAdopted,  bool isDeleted,  DateTime? deletedAt)?  $default,) {final _that = this;
switch (_that) {
case _Pet() when $default != null:
return $default(_that.id,_that.uid,_that.name,_that.address,_that.gender,_that.age,_that.weight,_that.species,_that.breed,_that.description,_that.imageUrl,_that.createdAt,_that.updatedAt,_that.isAdopted,_that.isDeleted,_that.deletedAt);case _:
  return null;
...
class _Pet implements Pet {
  const _Pet({required this.id, required this.uid, required this.name, required this.address, required this.gender, required this.age, required this.weight, required this.species, required this.breed, required this.description, required this.imageUrl, required this.createdAt, required this.updatedAt, required this.isAdopted, required this.isDeleted, required this.deletedAt});
