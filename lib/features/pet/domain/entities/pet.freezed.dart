...
mixin _$Pet {
 ...
 String get id; String get uid; String get name; String get address; Gender get gender; String? get age; String? get weight; String get category; String get species; String get description; String get imageUrl; DateTime get createdAt; DateTime get updatedAt; bool get isAdopted; bool get isDeleted;
...
@override
int get hashCode => Object.hash(runtimeType,id,uid,name,address,gender,age,weight,category,species,description,imageUrl,createdAt,updatedAt,isAdopted,isDeleted);

@override
String toString() {
  return 'Pet(id: $id, uid: $uid, name: $name, address: $address, gender: $gender, age: $age, weight: $weight, category: $category, species: $species, description: $description, imageUrl: $imageUrl, createdAt: $createdAt, updatedAt: $updatedAt, isAdopted: $isAdopted, isDeleted: $isDeleted)';
}
...
@useResult
$Res call({
 String id, String uid, String name, String address, Gender gender, String? age, String? weight, String category, String species, String description, String imageUrl, DateTime createdAt, DateTime updatedAt, bool isAdopted, bool isDeleted
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String uid,  String name,  String address,  Gender gender,  String? age,  String? weight,  String category,  String species,  String description,  String imageUrl,  DateTime createdAt,  DateTime updatedAt,  bool isAdopted,  bool isDeleted)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Pet() when $default != null:
return $default(_that.id,_that.uid,_that.name,_that.address,_that.gender,_that.age,_that.weight,_that.category,_that.species,_that.description,_that.imageUrl,_that.createdAt,_that.updatedAt,_that.isAdopted,_that.isDeleted);case _:
  return orElse();
...
class _Pet implements Pet {
  const _Pet({required this.id, required this.uid, required this.name, required this.address, required this.gender, required this.age, required this.weight, required this.category, required this.species, required this.description, required this.imageUrl, required this.createdAt, required this.updatedAt, required this.isAdopted, required this.isDeleted});
