...
@override
String toString() {
  return 'PetModel(id: $id, uid: $uid, name: $name, address: $address, gender: $gender, age: $age, weight: $weight, categoryId: $categoryId, species: $species, description: $description, imageUrl: $imageUrl, createdAt: $createdAt, updatedAt: $updatedAt, status: $status, isDeleted: $isDeleted)';
}
...
@override@JsonKey() final  PetStatus status;
