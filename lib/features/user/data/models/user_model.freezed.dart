...
@override
String toString() {
  return 'UserModel(uid: $uid, email: $email, name: $name, phone: $phone, avatar: $avatar, createdAt: $createdAt)';
}
...
class _UserModel implements UserModel {
  const _UserModel({required this.uid, required this.email, this.name, this.phone, this.avatar, this.createdAt});
