          ...
          children: [
            ...
            _buildSection(
              ...
              'Petter là nền tảng phi thương mại kết nối người có thú cưng '
                  'cần tìm nhà mới với những người muốn nhận nuôi...',
            ),
            _buildSection(
              '2. Điều kiện sử dụng',
              '2.1 Yêu cầu về người dùng: Bạn phải từ 16 tuổi trở lên, '
                  'thông tin chính xác, mỗi người một tài khoản.\n'
                  '2.2 Tài khoản: Bạn chịu hoàn toàn trách nhiệm về mọi hoạt '
                  'động dưới tài khoản của mình.',
            ),
            _buildSection(
              '3. Quy tắc đăng tin',
            ...
            const Text('Liên hệ: hvhan.dev@gmail.com'),
