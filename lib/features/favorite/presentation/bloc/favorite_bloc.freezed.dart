...
class _ToggleFavorite implements FavoriteEvent {
  const _ToggleFavorite(this.params);
  

 final  FavoriteParams params;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ToggleFavorite&&(identical(other.params, params) || other.params == params));
}
...
@override
String toString() {
  return 'FavoriteEvent.toggleFavorite(params: $params)';
}
...
/// @nodoc
abstract mixin class _$ToggleFavoriteCopyWith<$Res> implements $FavoriteEventCopyWith<$Res> {
